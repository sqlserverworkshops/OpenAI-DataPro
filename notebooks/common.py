...
#load_dotenv()
#load_dotenv(r'C:\Git\AzureOpenAI\AOAI\AOAI\.env')
...
api_URI = os.getenv("AOAI_ENDPOINT")
api_KEY = os.getenv("AOAI_APIKEY")
#api_version = os.getenv("OPENAI_VERSION")
api_version = "2023-07-01-preview"
gpt_api_deployment = os.getenv("AOAI_GPT35_DEPLOYMENT")
ada_api_deployment = os.getenv("AOAI_EMBEDDING_DEPLOYMENT")
